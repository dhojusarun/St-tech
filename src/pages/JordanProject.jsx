        ...
        >
          <div className="grid md:grid-cols-2 gap-8 p-10 text-white">
            ...
            <div className="space-y-4 ">
              <h1 className="text-3xl font-semibold">Project Management Course</h1>
              ...
              <p className="text-lg">
                Hey I am Jordan. I am a Project Management professional
            ...
            <div className="flex justify-center">
              <img src={Project} alt="" className="w-72 mb-20 ml-50 -mt-10" />
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 p-4">
          ...
          <div className="lg:col-span-2 space-y-4 ">
            ...
            <p className="text-gray-600 font-medium text-justify pl-10">
              The Project Management program provides a structured approach to planning, executing, and delivering projects successfully. You will learn project lifecycle management, risk assessment, budgeting, scheduling, and team coordination. The course also introduces Agile and Scrum methodologies. By the end of the program, you will be able to manage projects efficiently, communicate with stakeholders, and apply project management tools in real-world scenarios.
            </p>
          ...
          <div className="bg-white shadow-lg relative -mt-25 rounded-xl p-4 h-fit">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-3">
                <button onClick={() => (isWish('jordanproject') ? removeFromWishlist('jordanproject') : addToWishlist({ id: 'jordanproject', title: 'Project Management', price: 10000 }))}>
                  <FaHeart className={`${isWish('jordanproject') ? 'text-red-500' : 'text-gray-400'} text-lg`} />
                </button>
                <RiShareForwardLine
            ...
            <div className="mt-4">
              <button onClick={() => addToCart({ id: 'jordanproject', title: 'Project Management', price: 10000 })} className="flex items-center gap-2 bg-[#003372] text-white px-4 py-2 rounded-xl w-full justify-center">
            ...
            <div className="flex items-center gap-4 bg-white shadow rounded-xl p-4 w-full max-w-xl">
              ...
              <div className="space-y-1 flex gap-15 items-center">
                <div>
                  ...
                  <p className="text-xl text-gray-500">Project Management</p>
                </div>
