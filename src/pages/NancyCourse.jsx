        ...
        <div className="grid lg:grid-cols-3 gap-8 p-4">
          ...
          <div className="bg-white shadow-lg relative -mt-25 rounded-xl p-4 h-fit">
            ...
            <div className="flex gap-3 mt-4">
              <button onClick={() => addToCart({ id: 'nancycourse', title: 'UI/UX Design', price: 10000 })} className="flex items-center gap-2 bg-[#003372] text-white px-4 py-2 rounded-xl w-full justify-center">
