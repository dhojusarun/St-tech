        ...
        >
          <div className="grid md:grid-cols-2 gap-8 p-10 text-white">
            ...
            <div className="space-y-4 ">
              <h1 className="text-3xl font-semibold">Mern Stack Course</h1>

              <div className="flex items-center gap-2">
                <img src={Henry} alt="" className="w-8 h-8 object-cover rounded-full" />
                <p>By Henry smith</p>
              </div>

              <p className="text-lg">
                Hey I am Henry smith. I am a Mernstack professional
            ...
            <div className="flex justify-center">
              <img src={Mern} alt="" className="w-72 mb-20 ml-50 -mt-10" />
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 p-4">
          ...
          <div className="lg:col-span-2 space-y-4 ">
            ...
            <p className="text-gray-600 font-medium text-justify pl-10">
              The MERN Stack program delivers a full-stack, development-focused approach to building modern web applications. You will learn front-end and back-end development using MongoDB, Express.js, React.js, and Node.js. The program covers API development, database management, authentication, and deployment. By the end of the course, you will be able to design, build, and deploy complete web applications and maintain a professional portfolio showcasing real-world full-stack projects.
            </p>
              ...
              <details open className="group border-b ">
                ...
                <div className="px-6 pb-4 space-y-3">
                  {[
                    ...
                    "Overview of Mern Stack Process",
                  ].map((item, i) => (
          ...
          <div className="bg-white shadow-lg relative -mt-25 rounded-xl p-4 h-fit">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-3">
                <button onClick={() => (isWish('henrymern') ? removeFromWishlist('henrymern') : addToWishlist({ id: 'henrymern', title: 'Mern Stack', price: 10000 }))}>
                  <FaHeart className={`${isWish('henrymern') ? 'text-red-500' : 'text-gray-400'} text-lg`} />
                </button>
                <RiShareForwardLine
            ...
            <div className=" mt-4">
              <button onClick={() => addToCart({ id: 'henrymern', title: 'Mern Stack', price: 10000 })} className="flex items-center gap-2 bg-[#003372] text-white px-4 py-2 rounded-xl w-full justify-center">
          ...
          <div className="bg-white relative left-243 -top-170 rounded-xl shadow-lg  p-4 mt-4 h-fit">
            ...
            <p className="text-gray-600 text-sm p-4 text-justify leading-6">
              To participate in the Mern Stack, Participants should have basic computer literacy and a strong interest in web and software development. Logical thinking and problem-solving abilities are important for writing and understanding code. Prior knowledge of HTML, CSS, or JavaScript is helpful but not mandatory for beginners. Commitment to regular practice and project work is essential, as full-stack development requires consistent hands-on learning.
            </p>
          </div>
          ...
          <div className="flex justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-4 bg-white shadow rounded-xl p-4 w-full max-w-xl">
              ...
              <div className="space-y-1 flex gap-15 items-center">
                <div>
                  <h3 className="font-semibold text-2xl">Henry Smith</h3>
                  <p className="text-xl text-gray-500">Mern Stack</p>
                </div>


                <div className="text-xl text-gray-600 mt-2">
                  <span className="flex items-center gap-2"><FaBook /> 2 Courses</span>
                  <span className="flex items-center gap-2"><PiStudent /> 25 Students</span>
            ...
            <div className="w-full md:w-1/3 text-xl">
              ...
              <ul className="text-[#003372] space-y-1">
                <li><NavLink to="/henrydata">• Data Science</NavLink></li>
              </ul>
            </div>
          </div>
        </div> <br />
